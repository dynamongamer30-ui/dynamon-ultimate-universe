...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dynamon Gamer — Dynamons World Mod APK & Hack Hub" },
      { name: "description", content: "Dynamon Gamer Space: download the best Dynamons World Mod APK and Dynamons World Hack builds. Free, community-rated, updated weekly by Dynamon Gamer for trainers everywhere." },
      { name: "author", content: "Dynamon Gamer" },
      { name: "theme-color", content: "#121218" },
      { property: "og:title", content: "Dynamon Gamer — Dynamons World Mod APK & Hack Hub" },
      { property: "og:description", content: "Download premium Dynamons World Mod APK and Hack builds — free, community-rated, updated weekly. From Dynamon Gamer Space." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Dynamon Gamer" },
    ...
    links: [
      ...
      { rel: "icon", href: "/icon-dark-32x32.png", sizes: "32x32", type: "image/png" },
