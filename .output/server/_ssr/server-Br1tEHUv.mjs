import "../_runtime.mjs";
import { n as globalthis_default, r as init_globalthis } from "../_libs/supabase__realtime-js+unenv.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/server-Br1tEHUv.js
init_globalthis();
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BPeTDfIW.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-SAyYAinp.mjs"),
		import("./start-BnVVmNAs.mjs"),
		import("./empty-plugin-adapters-CYwVrp8R.mjs")
	]);
	return {
		routerEntry,
		startEntry,
